...
| dsh-plugin-writing-guard | 0.7.0 | AI 写作痕迹守卫 + Scholarship Lock/作者风格档案；v0.7 新增"的"字链/平均句长/自黑免责/空洞热词密度（ko5.6sol 借鉴）+ SKILL.md | ✅ Config 兼容 cordis 4（`export const Config`→`const DEFAULT_CONFIG`） |
